...
function getInitialForm(promo: Promo | null): PromoFormValues {
  if (!promo) return defaultForm;
...
type PromoDialogFormProps = Omit<PromoDialogProps, "open">;

function PromoDialogForm({
  onOpenChange,
  promo,
  saving,
  onSaved,
