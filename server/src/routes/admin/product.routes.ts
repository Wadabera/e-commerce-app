...
import { getDbUserFromReq, requireAdmin, requireAdminToken } from "../../middleware/auth";
...
// Use admin token middleware for hardcoded admin login
adminProductRouter.use(requireAdminToken);
...
adminProductRouter.post(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    // Get admin user from requireAdminToken middleware
